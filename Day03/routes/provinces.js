...
const {
    ...
    deleteProvinceController} = require('../contollers/province.controller')


    router.get("/", getAllProvincesController);
    router.get("/:id", getProvinceByIdController);
    router.post("/", createProvinceController);
    router.put("/:id", updateProvinceController);
    router.delete("/:id", deleteProvinceController);
